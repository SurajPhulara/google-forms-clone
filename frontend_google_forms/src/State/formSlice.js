...
export const formSlice = createSlice({
  ...
  reducers: {
    ...
    save_form: (state, action) => {
      ...
      axios.post(`https://nice-pleat-crow.cyclic.app/saveform/${action.payload}`, { ...state })
    },
    save_form2: (state, action) => {
      // console.log("save 2 is called")
      axios.post(`https://nice-pleat-crow.cyclic.app/saveform/${action.payload}`, { ...initialState })
    },
